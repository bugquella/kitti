...
//   }
    ...
    std::string input_dir = "/home/hegaozhi/dftc/3D-object-detection/lidar2rosbag_KITTI-master/sequences/00/";
    std::string output_dir = "/home/hegaozhi/dftc/3D-object-detection/lidar2rosbag_KITTI-master/test/00";
    ...
    std::cout <<"size:  "<< file_lists.size()<<endl;
    ...
    for(int iter=0;iter<file_lists.size();iter++)
    {
        ...
        points.header.stamp = timestamp_ros.toSec();;
